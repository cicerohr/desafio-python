...
from src.Exercism.currency_exchange.exchange import (
    exchange_money,
    exchangeable_value,
    get_change,
...
class CurrencyExchangeTest(unittest.TestCase):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertAlmostEqual(
                    exchange_money(input_data[0], input_data[1]), output_data
                )
    ...
    def test_get_change(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertAlmostEqual(
                    get_change(input_data[0], input_data[1]), output_data
                )
    ...
    def test_get_value_of_bills(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertEqual(
                    get_value_of_bills(input_data[0], input_data[1]),
                    output_data,
                )
    ...
    def test_get_number_of_bills(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertEqual(
                    get_number_of_bills(input_data[0], input_data[1]),
                    output_data,
                )
    ...
    def test_get_leftover_of_bills(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertAlmostEqual(
                    get_leftover_of_bills(input_data[0], input_data[1]),
                    output_data,
                )
    ...
    def test_exchangeable_value(self):
        ...
        for variant, (inputs, output_data) in enumerate(
            zip(inputs, output_data), start=1
        ):
            with self.subTest(
                f'variation #{variant}', inputs=inputs, output_data=output_data
            ):
                self.assertEqual(
                    exchangeable_value(
